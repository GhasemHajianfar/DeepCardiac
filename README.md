...
HDF5 file containing image array data.

numerical_feature.xlsx

Excel file containing numerical features.

zscore.pkl

Pickle file containing a pre-trained z-score transformer.

threshold.xlsx

Excel file containing thresholds.

model.hdf5

HDF5 file of the pre-trained model.

model_weight.h5

File containing weights of the pre-trained model.
...
Generated saliency map saved as a JPG image.
...
Prepare the input files (img_array.h5, numerical_feature.xlsx, zscore.pkl, etc.) in the same directory as the script.

Run the script using python3 inference_script.py.

View the outputs in the terminal and the generated saliency map at Silency_map.jpg.
